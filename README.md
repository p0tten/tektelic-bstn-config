...
This repository contains a complete toolkit for deploying a LoRaWAN infrastructure using ChirpStack and Tektelic Gateways.
...
You do NOT need to use both of these methods!